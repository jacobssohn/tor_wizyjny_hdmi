...
HD_PWD='C:/Users/bjsmn1/Desktop/Uczelnia/SDwUP/Projekt/tor_wizyjny/tor_wizyjny.runs/color_difference_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log color_difference.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source color_difference.tcl
