...
#
# Generated by export_simulation on Tue Jun 20 15:50:19 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './div_gen_3.sh' script.

./div_gen_3.sh -reset_run
...
./div_gen_3.sh -noclean_files

For more information on the script, please type './div_gen_3.sh -help'.
