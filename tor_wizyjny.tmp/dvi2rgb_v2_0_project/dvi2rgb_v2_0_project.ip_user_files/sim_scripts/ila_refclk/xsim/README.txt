...
#
# Generated by export_simulation on Sat Jun 10 17:12:47 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './ila_refclk.sh' script.

./ila_refclk.sh -reset_run
...
./ila_refclk.sh -noclean_files

For more information on the script, please type './ila_refclk.sh -help'.
